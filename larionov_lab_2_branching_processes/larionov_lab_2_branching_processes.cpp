...
class MyGeometry {
public:
    //определяет существует ли треугольник со сторонами a, b, c.
    ...
    //определяет является ли треугольник со сторонами a, b, c прямоугольным.
    ...
    //вычисляет градусную меру угла (в треугольнике) напротив стороны oppoziteSide используя теорему косинусов.
    ...
    //определяет является ли треугольник со сторонами a, b, c остроугольным.
    ...
    //определяет является ли треугольник со сторонами a, b, c тупоугольным.
...
private:
    ...
    //производит вычисления по формуле полупериметров
